  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.actions}>
        <TouchableOpacity style={styles.actionButton} onPress={() => {setTransactionType("Send"); confirmTransaction()}}>
          <Icon name="arrow-up" size={30} color="#4a90e2" />
          <Text style={styles.actionText}>Send money</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.actionButton} onPress={() => {setTransactionType("Get"); confirmTransaction()}}>
      ...
      <View style={styles.cardsContainer}>
        ...
        <TouchableOpacity style={styles.card} onPress={() => {setWallet("Wallet number 1")}}>
          <Icon name="credit-card" size={20} color="#2c3e50" />
          <Text style={styles.cardText}>Wallet number 1</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.card} onPress={() => {setWallet("Wallet number 2")}}>
          <Icon name="credit-card" size={20} color="#2c3e50" />
      ...
      <View style={styles.transactionsContainer}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity style={styles.transactionItem} onPress={() => {setTransactionPartner(item.name)}}>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#f7f8fc", padding: 20 , marginTop: 30},
